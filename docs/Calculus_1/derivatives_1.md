...
$$f'(x) = \underbrace{10x^4}_{2\cdot5} - \underbrace{12x^2}_{4\cdot3} + \underbrace{7}_{7\cdot1} - \underbrace{0}_{\text{const}}$$
...
$$g'(x) = 3(-2x^{-3}) - 2\left(\frac{1}{3}x^{-2/3}\right)$$
